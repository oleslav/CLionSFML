...
namespace Collision {
            ...
            for (int i = Intersection.left; i < Intersection.left + Intersection.width; i++) {
                for (int j = Intersection.top; j < Intersection.top + Intersection.height; j++) {
                    ...
                    if (o1v.x > 0 && o1v.y > 0 && o2v.x > 0 && o2v.y > 0 &&
                        ...
                        if (Collision::BitmaskManager::GetPixel(mask1, Object1.getTexture(), (int) (o1v.x) + O1SubRect.left,
                                              (int) (o1v.y) + O1SubRect.top) > AlphaLimit &&
                            Collision::BitmaskManager::GetPixel(mask2, Object2.getTexture(), (int) (o2v.x) + O2SubRect.left,
    ...
    sf::Vector2f GetSpriteCenter(const sf::Sprite &Object) {
        ...
        return {AABB.left + AABB.width / 2.f, AABB.top + AABB.height / 2.f};
    }

    sf::Vector2f GetSpriteSize(const sf::Sprite &Object) {
        sf::IntRect OriginalSize = Object.getTextureRect();
        sf::Vector2f Scale = Object.getScale();
        return {OriginalSize.width * Scale.x, OriginalSize.height * Scale.y};
    }
